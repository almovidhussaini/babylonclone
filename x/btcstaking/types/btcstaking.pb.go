...
// source: ybtc/btcstaking/v1/btcstaking.proto
...
import (
	...
	types1 "github.com/amovidhussaini/ybtcclone/x/btccheckpoint/types"
...
// activating delegation on ybtc chain.
...
type FinalityProvider struct {
	...
	// If it's missing / empty, it's assumed the finality provider is operating in the ybtc chain.
...
func (m *FinalityProvider) GetSlashedybtcHeight() uint64 {
	if m != nil {
...
func (m *FinalityProviderWithMeta) GetSlashedybtcHeight() uint64 {
	if m != nil {
		return m.SlashedybtcHeight
	}
	return 0
...
type BTCDelegation struct {
	...
	DelegatorSig *github_com_ybtclabs_io_ybtc_types.BIP340Signature `protobuf:"bytes,12,opt,name=delegator_sig,json=delegatorSig,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.BIP340Signature" json:"delegator_sig,omitempty"`
...
type BTCUndelegation struct {
	...
	DelegatorSlashingSig *github_com_ybtclabs_io_ybtc_types.BIP340Signature `protobuf:"bytes,3,opt,name=delegator_slashing_sig,json=delegatorSlashingSig,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.BIP340Signature" json:"delegator_slashing_sig,omitempty"`
...
type SignatureInfo struct {
	...
	Sig *github_com_ybtclabs_io_ybtc_types.BIP340Signature `protobuf:"bytes,2,opt,name=sig,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.BIP340Signature" json:"sig,omitempty"`
}
...
type CovenantAdaptorSignatures struct {
	...
	CovPk *github_com_ybtclabs_io_ybtc_types.BIP340PubKey `protobuf:"bytes,1,opt,name=cov_pk,json=covPk,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.BIP340PubKey" json:"cov_pk,omitempty"`
...
func init() {
	proto.RegisterEnum("ybtc.btcstaking.v1.BTCDelegationStatus", BTCDelegationStatus_name, BTCDelegationStatus_value)
	proto.RegisterType((*FinalityProvider)(nil), "ybtc.btcstaking.v1.FinalityProvider")
	proto.RegisterType((*FinalityProviderWithMeta)(nil), "ybtc.btcstaking.v1.FinalityProviderWithMeta")
	proto.RegisterType((*BTCDelegation)(nil), "ybtc.btcstaking.v1.BTCDelegation")
	proto.RegisterType((*DelegatorUnbondingInfo)(nil), "ybtc.btcstaking.v1.DelegatorUnbondingInfo")
	proto.RegisterType((*BTCUndelegation)(nil), "ybtc.btcstaking.v1.BTCUndelegation")
	proto.RegisterType((*BTCDelegatorDelegations)(nil), "ybtc.btcstaking.v1.BTCDelegatorDelegations")
	proto.RegisterType((*BTCDelegatorDelegationIndex)(nil), "ybtc.btcstaking.v1.BTCDelegatorDelegationIndex")
	proto.RegisterType((*SignatureInfo)(nil), "ybtc.btcstaking.v1.SignatureInfo")
	proto.RegisterType((*CovenantAdaptorSignatures)(nil), "ybtc.btcstaking.v1.CovenantAdaptorSignatures")
	proto.RegisterType((*SelectiveSlashingEvidence)(nil), "ybtc.btcstaking.v1.SelectiveSlashingEvidence")
	proto.RegisterType((*InclusionProof)(nil), "ybtc.btcstaking.v1.InclusionProof")
}

func init() {
	proto.RegisterFile("ybtc/btcstaking/v1/btcstaking.proto", fileDescriptor_3851ae95ccfaf7db)
}
...
func (m *FinalityProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SlashedybtcHeight != 0 {
		i = encodeVarintBtcstaking(dAtA, i, uint64(m.SlashedybtcHeight))
		i--
		dAtA[i] = 0x30
	}
	if m.Pop != nil {
...
func (m *FinalityProvider) Size() (n int) {
	...
	if m.SlashedybtcHeight != 0 {
		n += 1 + sovBtcstaking(uint64(m.SlashedybtcHeight))
	}
	if m.SlashedBtcHeight != 0 {
