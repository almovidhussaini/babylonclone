...
// source: ybtc/btcstaking/v1/pop.proto
...
// ProofOfPossessionBTC is the proof of possession that a ybtc
...
type ProofOfPossessionBTC struct {
	...
	BtcSigType BTCSigType `protobuf:"varint,1,opt,name=btc_sig_type,json=btcSigType,proto3,enum=ybtc.btcstaking.v1.BTCSigType" json:"btc_sig_type,omitempty"`
	// btc_sig is the signature generated via sign(sk_btc, ybtc_staker_address)
...
func init() {
	proto.RegisterEnum("ybtc.btcstaking.v1.BTCSigType", BTCSigType_name, BTCSigType_value)
	proto.RegisterType((*ProofOfPossessionBTC)(nil), "ybtc.btcstaking.v1.ProofOfPossessionBTC")
	proto.RegisterType((*BIP322Sig)(nil), "ybtc.btcstaking.v1.BIP322Sig")
}

func init() { proto.RegisterFile("ybtc/btcstaking/v1/pop.proto", fileDescriptor_9d6ceb088d9e9f3a) }
