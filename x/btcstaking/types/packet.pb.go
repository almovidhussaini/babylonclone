...
// source: ybtc/btcstaking/v1/packet.proto
...
// ConsumerIBCPacket is an IBC packet sent from consumer to ybtc
...
// BTCStakingIBCPacket is an IBC packet sent from ybtc to a consumer
...
// NewFinalityProvider is an IBC packet sent from ybtc to consumer
...
type NewFinalityProvider struct {
	...
	// If it's missing / empty, it's assumed the finality provider is operating in ybtc.
...
// ActiveBTCDelegation is an IBC packet sent from ybtc to consumer
...
// SlashedBTCDelegation is an IBC packet sent from ybtc to consumer
...
// UnbondedBTCDelegation is an IBC packet sent from ybtc to consumer
...
func init() {
	proto.RegisterType((*ConsumerIBCPacket)(nil), "ybtc.btcstaking.v1.ConsumerIBCPacket")
	proto.RegisterType((*SlashedFinalityProvider)(nil), "ybtc.btcstaking.v1.SlashedFinalityProvider")
	proto.RegisterType((*BTCStakingIBCPacket)(nil), "ybtc.btcstaking.v1.BTCStakingIBCPacket")
	proto.RegisterType((*NewFinalityProvider)(nil), "ybtc.btcstaking.v1.NewFinalityProvider")
	proto.RegisterType((*ActiveBTCDelegation)(nil), "ybtc.btcstaking.v1.ActiveBTCDelegation")
	proto.RegisterType((*BTCUndelegationInfo)(nil), "ybtc.btcstaking.v1.BTCUndelegationInfo")
	proto.RegisterType((*SlashedBTCDelegation)(nil), "ybtc.btcstaking.v1.SlashedBTCDelegation")
	proto.RegisterType((*UnbondedBTCDelegation)(nil), "ybtc.btcstaking.v1.UnbondedBTCDelegation")
	proto.RegisterType((*BTCStakingConsumerEvent)(nil), "ybtc.btcstaking.v1.BTCStakingConsumerEvent")
}

func init() {
	proto.RegisterFile("ybtc/btcstaking/v1/packet.proto", fileDescriptor_3ed0d17ad14d6c0e)
}

var fileDescriptor_3ed0d17ad14d6c0e = []byte{
	// 1101 bytes of a gzipped FileDescriptorProto
	,
}
