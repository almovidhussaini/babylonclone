...
// source: ybtc/btcstaking/v1/params.proto
...
type Params struct {
	...
	CovenantPks []github_com_ybtclabs_io_ybtc_types.BIP340PubKey `protobuf:"bytes,1,rep,name=covenant_pks,json=covenantPks,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.BIP340PubKey" json:"covenant_pks,omitempty"`
	...
	// i.e all staking transactions are allowed to enter ybtc chain afterwards
...
func init() {
	proto.RegisterType((*Params)(nil), "ybtc.btcstaking.v1.Params")
	proto.RegisterType((*HeightVersionPair)(nil), "ybtc.btcstaking.v1.HeightVersionPair")
	proto.RegisterType((*HeightToVersionMap)(nil), "ybtc.btcstaking.v1.HeightToVersionMap")
	proto.RegisterType((*StoredParams)(nil), "ybtc.btcstaking.v1.StoredParams")
}

func init() {
	proto.RegisterFile("ybtc/btcstaking/v1/params.proto", fileDescriptor_8d1392776a3e15b9)
}
