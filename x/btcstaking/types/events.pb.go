...
type EventPowerDistUpdate_EventSlashedFinalityProvider struct {
	Pk *github_com_babylonlabs_io_babylon_types.BIP340PubKey `protobuf:"bytes,1,opt,name=pk,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BIP340PubKey" json:"pk,omitempty"`
}
