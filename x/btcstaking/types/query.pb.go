...
type BTCDelegationResponse struct {
	...
	// the PK follows encoding in BIP-340 spec
	BtcPk *github_com_babylonlabs_io_babylon_types.BIP340PubKey `protobuf:"bytes,2,opt,name=btc_pk,json=btcPk,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BIP340PubKey" json:"btc_pk,omitempty"`
	// fp_btc_pk_list is the list of BIP-340 PKs of the finality providers that
	// this BTC delegation delegates to
	FpBtcPkList []github_com_babylonlabs_io_babylon_types.BIP340PubKey `protobuf:"bytes,3,rep,name=fp_btc_pk_list,json=fpBtcPkList,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BIP340PubKey" json:"fp_btc_pk_list,omitempty"`
...
type FinalityProviderResponse struct {
	...
	// the PK follows encoding in BIP-340 spec
	BtcPk *github_com_babylonlabs_io_babylon_types.BIP340PubKey `protobuf:"bytes,4,opt,name=btc_pk,json=btcPk,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BIP340PubKey" json:"btc_pk,omitempty"`
