...
// source: ybtc/btcstaking/v1/genesis.proto
...
type GenesisState struct {
	...
	// block_height_chains the block height of ybtc and bitcoin.
...
type BlockHeightBbnToBtc struct {
	// block_height_bbn is the height of the block in the ybtc chain.
...
type BTCDelegator struct {
	...
	DelBtcPk *github_com_ybtclabs_io_ybtc_types.BIP340PubKey `protobuf:"bytes,3,opt,name=del_btc_pk,json=delBtcPk,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.BIP340PubKey" json:"del_btc_pk,omitempty"`
}
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ybtc.btcstaking.v1.GenesisState")
	proto.RegisterType((*BlockHeightBbnToBtc)(nil), "ybtc.btcstaking.v1.BlockHeightBbnToBtc")
	proto.RegisterType((*BTCDelegator)(nil), "ybtc.btcstaking.v1.BTCDelegator")
	proto.RegisterType((*EventIndex)(nil), "ybtc.btcstaking.v1.EventIndex")
}

func init() {
	proto.RegisterFile("ybtc/btcstaking/v1/genesis.proto", fileDescriptor_85d7b95fa5620238)
}
