...
type FinalityProviderDistInfo struct {
	...
	BtcPk *github_com_babylonlabs_io_babylon_types.BIP340PubKey `protobuf:"bytes,1,opt,name=btc_pk,json=btcPk,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BIP340PubKey" json:"btc_pk,omitempty"`
...
type Evidence struct {
	...
	FpBtcPk *github_com_babylonlabs_io_babylon_types.BIP340PubKey `protobuf:"bytes,1,opt,name=fp_btc_pk,json=fpBtcPk,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BIP340PubKey" json:"fp_btc_pk,omitempty"`
