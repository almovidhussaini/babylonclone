...
import (
	context "context"
	fmt "fmt"
	github_com_babylonlabs_io_babylon_types "github.com/almovidhussaini/babylonclone/types"
...
type ActiveFinalityProvidersAtHeightResponse struct {
	...
	// the PK follows encoding in BIP-340 spec
	BtcPkHex *github_com_babylonlabs_io_babylon_types.BIP340PubKey `protobuf:"bytes,1,opt,name=btc_pk_hex,json=btcPkHex,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BIP340PubKey" json:"btc_pk_hex,omitempty"`
...
type QueryListPublicRandomnessResponse struct {
	...
	PubRandMap map[uint64]*github_com_babylonlabs_io_babylon_types.SchnorrPubRand `protobuf:"bytes,1,rep,name=pub_rand_map,json=pubRandMap,proto3,customtype=github.com/almovidhussaini/babylonclone/types.SchnorrPubRand" json:"pub_rand_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// pagination defines the pagination in the response.
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}
...
type QueryVotesAtHeightResponse struct {
	...
	// the PK follows encoding in BIP-340 spec
	BtcPks []github_com_babylonlabs_io_babylon_types.BIP340PubKey `protobuf:"bytes,1,rep,name=btc_pks,json=btcPks,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BIP340PubKey" json:"btc_pks,omitempty"`
}
...
type EvidenceResponse struct {
	...
	PubRand *github_com_babylonlabs_io_babylon_types.SchnorrPubRand `protobuf:"bytes,3,opt,name=pub_rand,json=pubRand,proto3,customtype=github.com/almovidhussaini/babylonclone/types.SchnorrPubRand" json:"pub_rand,omitempty"`
	...
	CanonicalFinalitySig *github_com_babylonlabs_io_babylon_types.SchnorrEOTSSig `protobuf:"bytes,6,opt,name=canonical_finality_sig,json=canonicalFinalitySig,proto3,customtype=github.com/almovidhussaini/babylonclone/types.SchnorrEOTSSig" json:"canonical_finality_sig,omitempty"`
	// fork_finality_sig is the finality signature to the fork block
	// where finality signature is an EOTS signature
	ForkFinalitySig *github_com_babylonlabs_io_babylon_types.SchnorrEOTSSig `protobuf:"bytes,7,opt,name=fork_finality_sig,json=forkFinalitySig,proto3,customtype=github.com/almovidhussaini/babylonclone/types.SchnorrEOTSSig" json:"fork_finality_sig,omitempty"`
}
