...
// source: ybtc/finality/v1/query.proto
...
import (
	context "context"
	fmt "fmt"
	github_com_ybtclabs_io_ybtc_types "github.com/amovidhussaini/ybtcclone/types"
...
type QueryActiveFinalityProvidersAtHeightRequest struct {
	// height defines at which ybtc height to query the finality providers info.
	Height uint64 `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
...
type ActiveFinalityProvidersAtHeightResponse struct {
	...
	// the PK follows encoding in BIP-340 spec
	BtcPkHex *github_com_ybtclabs_io_ybtc_types.BIP340PubKey `protobuf:"bytes,1,opt,name=btc_pk_hex,json=btcPkHex,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.BIP340PubKey" json:"btc_pk_hex,omitempty"`
	// height is the queried ybtc height
	Height uint64 `protobuf:"varint,2,opt,name=height,proto3" json:"height,omitempty"`
	...
	SlashedybtcHeight uint64 `protobuf:"varint,4,opt,name=slashed_ybtc_height,json=slashedybtcHeight,proto3" json:"slashed_ybtc_height,omitempty"`
...
func (m *ActiveFinalityProvidersAtHeightResponse) GetSlashedybtcHeight() uint64 {
	if m != nil {
		return m.SlashedybtcHeight
	}
	return 0
}
...
type QueryListPublicRandomnessResponse struct {
	...
	PubRandMap map[uint64]*github_com_ybtclabs_io_ybtc_types.SchnorrPubRand `protobuf:"bytes,1,rep,name=pub_rand_map,json=pubRandMap,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.SchnorrPubRand" json:"pub_rand_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// pagination defines the pagination in the response.
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}
...
type QueryBlockRequest struct {
	// height is the height of the ybtc block
	Height uint64 `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
}
...
type QueryBlockResponse struct {
	// block is the ybtc at the given height
...
type QueryListBlocksRequest struct {
	...
	Status QueriedBlockStatus `protobuf:"varint,1,opt,name=status,proto3,enum=ybtc.finality.v1.QueriedBlockStatus" json:"status,omitempty"`
	// pagination defines an optional pagination for the request.
	Pagination *query.PageRequest `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}
...
type QueryVotesAtHeightResponse struct {
	...
	// the PK follows encoding in BIP-340 spec
	BtcPks []github_com_ybtclabs_io_ybtc_types.BIP340PubKey `protobuf:"bytes,1,rep,name=btc_pks,json=btcPks,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.BIP340PubKey" json:"btc_pks,omitempty"`
}
...
type EvidenceResponse struct {
	...
	PubRand *github_com_ybtclabs_io_ybtc_types.SchnorrPubRand `protobuf:"bytes,3,opt,name=pub_rand,json=pubRand,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.SchnorrPubRand" json:"pub_rand,omitempty"`
	...
	CanonicalFinalitySig *github_com_ybtclabs_io_ybtc_types.SchnorrEOTSSig `protobuf:"bytes,6,opt,name=canonical_finality_sig,json=canonicalFinalitySig,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.SchnorrEOTSSig" json:"canonical_finality_sig,omitempty"`
	// fork_finality_sig is the finality signature to the fork block
	// where finality signature is an EOTS signature
	ForkFinalitySig *github_com_ybtclabs_io_ybtc_types.SchnorrEOTSSig `protobuf:"bytes,7,opt,name=fork_finality_sig,json=forkFinalitySig,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.SchnorrEOTSSig" json:"fork_finality_sig,omitempty"`
}
...
func init() {
	proto.RegisterEnum("ybtc.finality.v1.QueriedBlockStatus", QueriedBlockStatus_name, QueriedBlockStatus_value)
	proto.RegisterType((*QueryParamsRequest)(nil), "ybtc.finality.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "ybtc.finality.v1.QueryParamsResponse")
	proto.RegisterType((*QueryFinalityProviderPowerAtHeightRequest)(nil), "ybtc.finality.v1.QueryFinalityProviderPowerAtHeightRequest")
	proto.RegisterType((*QueryFinalityProviderPowerAtHeightResponse)(nil), "ybtc.finality.v1.QueryFinalityProviderPowerAtHeightResponse")
	proto.RegisterType((*QueryFinalityProviderCurrentPowerRequest)(nil), "ybtc.finality.v1.QueryFinalityProviderCurrentPowerRequest")
	proto.RegisterType((*QueryFinalityProviderCurrentPowerResponse)(nil), "ybtc.finality.v1.QueryFinalityProviderCurrentPowerResponse")
	proto.RegisterType((*QueryActiveFinalityProvidersAtHeightRequest)(nil), "ybtc.finality.v1.QueryActiveFinalityProvidersAtHeightRequest")
	proto.RegisterType((*ActiveFinalityProvidersAtHeightResponse)(nil), "ybtc.finality.v1.ActiveFinalityProvidersAtHeightResponse")
	proto.RegisterType((*QueryActiveFinalityProvidersAtHeightResponse)(nil), "ybtc.finality.v1.QueryActiveFinalityProvidersAtHeightResponse")
	proto.RegisterType((*QueryActivatedHeightRequest)(nil), "ybtc.finality.v1.QueryActivatedHeightRequest")
	proto.RegisterType((*QueryActivatedHeightResponse)(nil), "ybtc.finality.v1.QueryActivatedHeightResponse")
	proto.RegisterType((*QueryListPublicRandomnessRequest)(nil), "ybtc.finality.v1.QueryListPublicRandomnessRequest")
	proto.RegisterType((*QueryListPublicRandomnessResponse)(nil), "ybtc.finality.v1.QueryListPublicRandomnessResponse")
	proto.RegisterMapType((map[uint64]*github_com_ybtclabs_io_ybtc_types.SchnorrPubRand)(nil), "ybtc.finality.v1.QueryListPublicRandomnessResponse.PubRandMapEntry")
	proto.RegisterType((*PubRandCommitResponse)(nil), "ybtc.finality.v1.PubRandCommitResponse")
	proto.RegisterType((*QueryListPubRandCommitRequest)(nil), "ybtc.finality.v1.QueryListPubRandCommitRequest")
	proto.RegisterType((*QueryListPubRandCommitResponse)(nil), "ybtc.finality.v1.QueryListPubRandCommitResponse")
	proto.RegisterMapType((map[uint64]*PubRandCommitResponse)(nil), "ybtc.finality.v1.QueryListPubRandCommitResponse.PubRandCommitMapEntry")
	proto.RegisterType((*QueryBlockRequest)(nil), "ybtc.finality.v1.QueryBlockRequest")
	proto.RegisterType((*QueryBlockResponse)(nil), "ybtc.finality.v1.QueryBlockResponse")
	proto.RegisterType((*QueryListBlocksRequest)(nil), "ybtc.finality.v1.QueryListBlocksRequest")
	proto.RegisterType((*QueryListBlocksResponse)(nil), "ybtc.finality.v1.QueryListBlocksResponse")
	proto.RegisterType((*QueryVotesAtHeightRequest)(nil), "ybtc.finality.v1.QueryVotesAtHeightRequest")
	proto.RegisterType((*QueryVotesAtHeightResponse)(nil), "ybtc.finality.v1.QueryVotesAtHeightResponse")
	proto.RegisterType((*QueryEvidenceRequest)(nil), "ybtc.finality.v1.QueryEvidenceRequest")
	proto.RegisterType((*EvidenceResponse)(nil), "ybtc.finality.v1.EvidenceResponse")
	proto.RegisterType((*QueryEvidenceResponse)(nil), "ybtc.finality.v1.QueryEvidenceResponse")
	proto.RegisterType((*QueryListEvidencesRequest)(nil), "ybtc.finality.v1.QueryListEvidencesRequest")
	proto.RegisterType((*QueryListEvidencesResponse)(nil), "ybtc.finality.v1.QueryListEvidencesResponse")
	proto.RegisterType((*QuerySigningInfoRequest)(nil), "ybtc.finality.v1.QuerySigningInfoRequest")
	proto.RegisterType((*SigningInfoResponse)(nil), "ybtc.finality.v1.SigningInfoResponse")
	proto.RegisterType((*QuerySigningInfoResponse)(nil), "ybtc.finality.v1.QuerySigningInfoResponse")
	proto.RegisterType((*QuerySigningInfosRequest)(nil), "ybtc.finality.v1.QuerySigningInfosRequest")
	proto.RegisterType((*QuerySigningInfosResponse)(nil), "ybtc.finality.v1.QuerySigningInfosResponse")
}

func init() { proto.RegisterFile("ybtc/finality/v1/query.proto", fileDescriptor_32bddab77af6fdae) }
...
var fileDescriptor_32bddab77af6fdae = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// NOTE: ybtc only has the knowledge of public randomness that is already revealed by
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ActiveFinalityProvidersAtHeight(ctx context.Context, in *QueryActiveFinalityProvidersAtHeightRequest, opts ...grpc.CallOption) (*QueryActiveFinalityProvidersAtHeightResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/ActiveFinalityProvidersAtHeight", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) FinalityProviderPowerAtHeight(ctx context.Context, in *QueryFinalityProviderPowerAtHeightRequest, opts ...grpc.CallOption) (*QueryFinalityProviderPowerAtHeightResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/FinalityProviderPowerAtHeight", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) FinalityProviderCurrentPower(ctx context.Context, in *QueryFinalityProviderCurrentPowerRequest, opts ...grpc.CallOption) (*QueryFinalityProviderCurrentPowerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/FinalityProviderCurrentPower", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ActivatedHeight(ctx context.Context, in *QueryActivatedHeightRequest, opts ...grpc.CallOption) (*QueryActivatedHeightResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/ActivatedHeight", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListPublicRandomness(ctx context.Context, in *QueryListPublicRandomnessRequest, opts ...grpc.CallOption) (*QueryListPublicRandomnessResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/ListPublicRandomness", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListPubRandCommit(ctx context.Context, in *QueryListPubRandCommitRequest, opts ...grpc.CallOption) (*QueryListPubRandCommitResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/ListPubRandCommit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Block(ctx context.Context, in *QueryBlockRequest, opts ...grpc.CallOption) (*QueryBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/Block", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListBlocks(ctx context.Context, in *QueryListBlocksRequest, opts ...grpc.CallOption) (*QueryListBlocksResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/ListBlocks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) VotesAtHeight(ctx context.Context, in *QueryVotesAtHeightRequest, opts ...grpc.CallOption) (*QueryVotesAtHeightResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/VotesAtHeight", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Evidence(ctx context.Context, in *QueryEvidenceRequest, opts ...grpc.CallOption) (*QueryEvidenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/Evidence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListEvidences(ctx context.Context, in *QueryListEvidencesRequest, opts ...grpc.CallOption) (*QueryListEvidencesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/ListEvidences", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SigningInfo(ctx context.Context, in *QuerySigningInfoRequest, opts ...grpc.CallOption) (*QuerySigningInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/SigningInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SigningInfos(ctx context.Context, in *QuerySigningInfosRequest, opts ...grpc.CallOption) (*QuerySigningInfosResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ybtc.finality.v1.Query/SigningInfos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/Params",
	}
...
func _Query_ActiveFinalityProvidersAtHeight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/ActiveFinalityProvidersAtHeight",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_FinalityProviderPowerAtHeight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/FinalityProviderPowerAtHeight",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_FinalityProviderCurrentPower_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/FinalityProviderCurrentPower",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ActivatedHeight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/ActivatedHeight",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ListPublicRandomness_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/ListPublicRandomness",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ListPubRandCommit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/ListPubRandCommit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Block_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/Block",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ListBlocks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/ListBlocks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_VotesAtHeight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/VotesAtHeight",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Evidence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/Evidence",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ListEvidences_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/ListEvidences",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_SigningInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/SigningInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_SigningInfos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ybtc.finality.v1.Query/SigningInfos",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ybtc.finality.v1.Query",
	...
	Metadata: "ybtc/finality/v1/query.proto",
}
...
func (m *ActiveFinalityProvidersAtHeightResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SlashedybtcHeight != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.SlashedybtcHeight))
		i--
		dAtA[i] = 0x20
	}
	if m.VotingPower != 0 {
...
func (m *ActiveFinalityProvidersAtHeightResponse) Size() (n int) {
	...
	if m.SlashedybtcHeight != 0 {
		n += 1 + sovQuery(uint64(m.SlashedybtcHeight))
	}
	if m.SlashedBtcHeight != 0 {
...
func (m *ActiveFinalityProvidersAtHeightResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			var v github_com_ybtclabs_io_ybtc_types.BIP340PubKey
			m.BtcPkHex = &v
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SlashedybtcHeight", wireType)
			}
			m.SlashedybtcHeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowQuery
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SlashedybtcHeight |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *QueryListPublicRandomnessResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.PubRandMap == nil {
				m.PubRandMap = make(map[uint64]*github_com_ybtclabs_io_ybtc_types.SchnorrPubRand)
			}
			var mapkey uint64
			var mapvalue1 github_com_ybtclabs_io_ybtc_types.SchnorrPubRand
			...
			m.PubRandMap[mapkey] = ((*github_com_ybtclabs_io_ybtc_types.SchnorrPubRand)(mapvalue))
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Pagination", wireType)
...
func (m *EvidenceResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			var v github_com_ybtclabs_io_ybtc_types.SchnorrPubRand
			m.PubRand = &v
		...
		case 6:
			...
			var v github_com_ybtclabs_io_ybtc_types.SchnorrEOTSSig
