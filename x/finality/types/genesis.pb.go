...
// source: ybtc/finality/v1/genesis.proto
...
type VoteSig struct {
	...
	FinalitySig *github_com_ybtclabs_io_ybtc_types.SchnorrEOTSSig `protobuf:"bytes,3,opt,name=finality_sig,json=finalitySig,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.SchnorrEOTSSig" json:"finality_sig,omitempty"`
}
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ybtc.finality.v1.GenesisState")
	proto.RegisterType((*VoteSig)(nil), "ybtc.finality.v1.VoteSig")
	proto.RegisterType((*PublicRandomness)(nil), "ybtc.finality.v1.PublicRandomness")
	proto.RegisterType((*PubRandCommitWithPK)(nil), "ybtc.finality.v1.PubRandCommitWithPK")
	proto.RegisterType((*SigningInfo)(nil), "ybtc.finality.v1.SigningInfo")
	proto.RegisterType((*FinalityProviderMissedBlocks)(nil), "ybtc.finality.v1.FinalityProviderMissedBlocks")
	proto.RegisterType((*MissedBlock)(nil), "ybtc.finality.v1.MissedBlock")
	proto.RegisterType((*VotingPowerFP)(nil), "ybtc.finality.v1.VotingPowerFP")
	proto.RegisterType((*VotingPowerDistCacheBlkHeight)(nil), "ybtc.finality.v1.VotingPowerDistCacheBlkHeight")
}

func init() { proto.RegisterFile("ybtc/finality/v1/genesis.proto", fileDescriptor_52dc577f74d797d1) }
