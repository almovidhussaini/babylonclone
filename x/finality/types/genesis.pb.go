...
type VoteSig struct {
	...
	FinalitySig *github_com_babylonlabs_io_babylon_types.SchnorrEOTSSig `protobuf:"bytes,3,opt,name=finality_sig,json=finalitySig,proto3,customtype=github.com/almovidhussaini/babylonclone/types.SchnorrEOTSSig" json:"finality_sig,omitempty"`
}
