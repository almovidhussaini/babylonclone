...
// source: ybtc/finality/v1/params.proto
...
type Params struct {
	...
	// finality_activation_height is the ybtc block height which the finality module will
...
func init() {
	proto.RegisterType((*Params)(nil), "ybtc.finality.v1.Params")
}

func init() { proto.RegisterFile("ybtc/finality/v1/params.proto", fileDescriptor_25539c9a61c72ee9) }
