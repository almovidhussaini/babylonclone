...
// source: ybtc/finality/v1/events.proto
...
func init() {
	proto.RegisterType((*EventSlashedFinalityProvider)(nil), "ybtc.finality.v1.EventSlashedFinalityProvider")
	proto.RegisterType((*EventJailedFinalityProvider)(nil), "ybtc.finality.v1.EventJailedFinalityProvider")
}

func init() { proto.RegisterFile("ybtc/finality/v1/events.proto", fileDescriptor_c34c03aae5e3e6bf) }
