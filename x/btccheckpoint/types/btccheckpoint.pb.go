...
type BTCSpvProof struct {
	...
	ConfirmingBtcHeader *github_com_babylonlabs_io_babylon_types.BTCHeaderBytes `protobuf:"bytes,4,opt,name=confirming_btc_header,json=confirmingBtcHeader,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BTCHeaderBytes" json:"confirming_btc_header,omitempty"`
}
...
type BTCCheckpointInfo struct {
	...
	BestSubmissionBtcBlockHash *github_com_babylonlabs_io_babylon_types.BTCHeaderHashBytes `protobuf:"bytes,3,opt,name=best_submission_btc_block_hash,json=bestSubmissionBtcBlockHash,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BTCHeaderHashBytes" json:"best_submission_btc_block_hash,omitempty"`
