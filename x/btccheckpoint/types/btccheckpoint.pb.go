...
// source: ybtc/btccheckpoint/v1/btccheckpoint.proto
...
type BTCSpvProof struct {
	...
	ConfirmingBtcHeader *github_com_ybtclabs_io_ybtc_types.BTCHeaderBytes `protobuf:"bytes,4,opt,name=confirming_btc_header,json=confirmingBtcHeader,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.BTCHeaderBytes" json:"confirming_btc_header,omitempty"`
}
...
type TransactionKey struct {
	...
	Hash  *github_com_ybtclabs_io_ybtc_types.BTCHeaderHashBytes `protobuf:"bytes,2,opt,name=hash,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.BTCHeaderHashBytes" json:"hash,omitempty"`
}
...
type EpochData struct {
	...
	Status BtcStatus `protobuf:"varint,2,opt,name=status,proto3,enum=ybtc.btccheckpoint.v1.BtcStatus" json:"status,omitempty"`
}
...
type BTCCheckpointInfo struct {
	...
	BestSubmissionBtcBlockHash *github_com_ybtclabs_io_ybtc_types.BTCHeaderHashBytes `protobuf:"bytes,3,opt,name=best_submission_btc_block_hash,json=bestSubmissionBtcBlockHash,proto3,customtype=github.com/amovidhussaini/ybtcclone/types.BTCHeaderHashBytes" json:"best_submission_btc_block_hash,omitempty"`
...
func init() {
	proto.RegisterEnum("ybtc.btccheckpoint.v1.BtcStatus", BtcStatus_name, BtcStatus_value)
	proto.RegisterType((*BTCSpvProof)(nil), "ybtc.btccheckpoint.v1.BTCSpvProof")
	proto.RegisterType((*TransactionKey)(nil), "ybtc.btccheckpoint.v1.TransactionKey")
	proto.RegisterType((*SubmissionKey)(nil), "ybtc.btccheckpoint.v1.SubmissionKey")
	proto.RegisterType((*TransactionInfo)(nil), "ybtc.btccheckpoint.v1.TransactionInfo")
	proto.RegisterType((*SubmissionData)(nil), "ybtc.btccheckpoint.v1.SubmissionData")
	proto.RegisterType((*EpochData)(nil), "ybtc.btccheckpoint.v1.EpochData")
	proto.RegisterType((*CheckpointAddresses)(nil), "ybtc.btccheckpoint.v1.CheckpointAddresses")
	proto.RegisterType((*BTCCheckpointInfo)(nil), "ybtc.btccheckpoint.v1.BTCCheckpointInfo")
}

func init() {
	proto.RegisterFile("ybtc/btccheckpoint/v1/btccheckpoint.proto", fileDescriptor_e096cac78d49b0a6)
}
