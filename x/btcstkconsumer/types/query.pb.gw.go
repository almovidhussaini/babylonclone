...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ybtc", "btcstkconsumer", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ConsumerRegistryList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ybtc", "btcstkconsumer", "v1", "consumer_registry_list"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ConsumersRegistry_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"ybtc", "btcstkconsumer", "v1", "consumers_registry", "consumer_ids"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_FinalityProviderConsumer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"ybtc", "btcstkconsumer", "v1", "finality_provider_consumer", "fp_btc_pk_hex"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_FinalityProviders_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"ybtc", "btcstkconsumer", "v1", "finality_providers", "consumer_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_FinalityProvider_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"ybtc", "btcstkconsumer", "v1", "finality_provider", "consumer_id", "fp_btc_pk_hex"}, "", runtime.AssumeColonVerbOpt(false)))
)
