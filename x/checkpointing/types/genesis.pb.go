...
// source: ybtc/checkpointing/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ybtc.checkpointing.v1.GenesisState")
	proto.RegisterType((*GenesisKey)(nil), "ybtc.checkpointing.v1.GenesisKey")
}

func init() {
	proto.RegisterFile("ybtc/checkpointing/v1/genesis.proto", fileDescriptor_bf2c524ebc9800de)
}
