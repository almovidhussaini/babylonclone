...
// source: ybtc/checkpointing/v1/checkpoint.proto
...
type RawCheckpointWithMeta struct {
	...
	BlsAggrPk *github_com_ybtclabs_io_ybtc_crypto_bls12381.PublicKey `protobuf:"bytes,3,opt,name=bls_aggr_pk,json=blsAggrPk,proto3,customtype=github.com/amovidhussaini/ybtcclone/crypto/bls12381.PublicKey" json:"bls_aggr_pk,omitempty"`
...
type BlsSig struct {
	...
	// the block that individual BLS sigs are signed on
	BlockHash *BlockHash                                                   `protobuf:"bytes,2,opt,name=block_hash,json=blockHash,proto3,customtype=BlockHash" json:"block_hash,omitempty"`
	BlsSig    *github_com_ybtclabs_io_ybtc_crypto_bls12381.Signature `protobuf:"bytes,3,opt,name=bls_sig,json=blsSig,proto3,customtype=github.com/amovidhussaini/ybtcclone/crypto/bls12381.Signature" json:"bls_sig,omitempty"`
...
func init() {
	proto.RegisterEnum("ybtc.checkpointing.v1.CheckpointStatus", CheckpointStatus_name, CheckpointStatus_value)
	proto.RegisterType((*RawCheckpoint)(nil), "ybtc.checkpointing.v1.RawCheckpoint")
	proto.RegisterType((*RawCheckpointWithMeta)(nil), "ybtc.checkpointing.v1.RawCheckpointWithMeta")
	proto.RegisterType((*MsgInjectedCheckpoint)(nil), "ybtc.checkpointing.v1.MsgInjectedCheckpoint")
	proto.RegisterType((*CheckpointStateUpdate)(nil), "ybtc.checkpointing.v1.CheckpointStateUpdate")
	proto.RegisterType((*BlsSig)(nil), "ybtc.checkpointing.v1.BlsSig")
}

func init() {
	proto.RegisterFile("ybtc/checkpointing/v1/checkpoint.proto", fileDescriptor_73996df9c6aabde4)
}
