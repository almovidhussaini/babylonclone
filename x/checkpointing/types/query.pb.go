...
import (
	context "context"
	fmt "fmt"
	github_com_babylonlabs_io_babylon_crypto_bls12381 "github.com/almovidhussaini/babylonclone/crypto/bls12381"
...
type RawCheckpointResponse struct {
	...
	// sigs
	BlsMultiSig *github_com_babylonlabs_io_babylon_crypto_bls12381.Signature `protobuf:"bytes,4,opt,name=bls_multi_sig,json=blsMultiSig,proto3,customtype=github.com/almovidhussaini/babylonclone/crypto/bls12381.Signature" json:"bls_multi_sig,omitempty"`
}
...
type RawCheckpointWithMetaResponse struct {
	...
	BlsAggrPk *github_com_babylonlabs_io_babylon_crypto_bls12381.PublicKey `protobuf:"bytes,4,opt,name=bls_aggr_pk,json=blsAggrPk,proto3,customtype=github.com/almovidhussaini/babylonclone/crypto/bls12381.PublicKey" json:"bls_aggr_pk,omitempty"`
