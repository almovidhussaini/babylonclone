...
// source: ybtc/checkpointing/v1/bls_key.proto
...
type BlsKey struct {
	...
	Pubkey *github_com_ybtclabs_io_ybtc_crypto_bls12381.PublicKey `protobuf:"bytes,1,opt,name=pubkey,proto3,customtype=github.com/amovidhussaini/ybtcclone/crypto/bls12381.PublicKey" json:"pubkey,omitempty"`
...
type ProofOfPossession struct {
	...
	// ed25519_sig)
	BlsSig *github_com_ybtclabs_io_ybtc_crypto_bls12381.Signature `protobuf:"bytes,2,opt,name=bls_sig,json=blsSig,proto3,customtype=github.com/amovidhussaini/ybtcclone/crypto/bls12381.Signature" json:"bls_sig,omitempty"`
}
...
type VoteExtension struct {
	...
	BlsSig *github_com_ybtclabs_io_ybtc_crypto_bls12381.Signature `protobuf:"bytes,6,opt,name=bls_sig,json=blsSig,proto3,customtype=github.com/amovidhussaini/ybtcclone/crypto/bls12381.Signature" json:"bls_sig,omitempty"`
}
...
func init() {
	proto.RegisterType((*BlsKey)(nil), "ybtc.checkpointing.v1.BlsKey")
	proto.RegisterType((*ProofOfPossession)(nil), "ybtc.checkpointing.v1.ProofOfPossession")
	proto.RegisterType((*ValidatorWithBlsKeySet)(nil), "ybtc.checkpointing.v1.ValidatorWithBlsKeySet")
	proto.RegisterType((*ValidatorWithBlsKey)(nil), "ybtc.checkpointing.v1.ValidatorWithBlsKey")
	proto.RegisterType((*VoteExtension)(nil), "ybtc.checkpointing.v1.VoteExtension")
}

func init() {
	proto.RegisterFile("ybtc/checkpointing/v1/bls_key.proto", fileDescriptor_3a8c0d37ce63f038)
}
