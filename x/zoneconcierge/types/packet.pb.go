...
// source: ybtc/zoneconcierge/v1/packet.proto

package types

import (
	fmt "fmt"
	types4 "github.com/amovidhussaini/ybtcclone/x/btccheckpoint/types"
	types1 "github.com/amovidhussaini/ybtcclone/x/btclightclient/types"
	types "github.com/amovidhussaini/ybtcclone/x/btcstaking/types"
	types3 "github.com/amovidhussaini/ybtcclone/x/checkpointing/types"
	types2 "github.com/amovidhussaini/ybtcclone/x/epoching/types"
	types5 "github.com/amovidhussaini/ybtcclone/x/finality/types"
...
// Upon a newly finalised epoch in ybtc, ybtc will send a BTC timestamp to each
// Cosmos zone that has phase-2 integration with ybtc via IBC.
type BTCTimestamp struct {
	...
	// where `lastFinalizedEpoch` is the last finalised epoch in ybtc
...
// ConsumerSlashingIBCPacket defines the slashing information that a Consumer sends to ybtc's ZoneConcierge upon a
...
type ConsumerSlashingIBCPacket struct {
	/// evidence is the FP slashing evidence that the Consumer sends to ybtc
...
func init() {
	proto.RegisterType((*ZoneconciergePacketData)(nil), "ybtc.zoneconcierge.v1.ZoneconciergePacketData")
	proto.RegisterType((*BTCTimestamp)(nil), "ybtc.zoneconcierge.v1.BTCTimestamp")
	proto.RegisterType((*ConsumerSlashingIBCPacket)(nil), "ybtc.zoneconcierge.v1.ConsumerSlashingIBCPacket")
}

func init() {
	proto.RegisterFile("ybtc/zoneconcierge/v1/packet.proto", fileDescriptor_be12e124c5c4fdb9)
}
