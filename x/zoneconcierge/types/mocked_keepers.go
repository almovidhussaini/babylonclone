...
import (
	...
	types2 "github.com/almovidhussaini/babylonclone/x/btcstaking/types"
	types3 "github.com/almovidhussaini/babylonclone/x/btcstkconsumer/types"
	types4 "github.com/almovidhussaini/babylonclone/x/checkpointing/types"
	types5 "github.com/almovidhussaini/babylonclone/x/epoching/types"
...
func (m *MockScopedKeeper) AuthenticateCapability(ctx types6.Context, cap *types7.Capability, name string) bool {
	m.ctrl.T.Helper()
...
func (m *MockScopedKeeper) ClaimCapability(ctx types6.Context, cap *types7.Capability, name string) error {
	m.ctrl.T.Helper()
...
func (m *MockScopedKeeper) GetCapability(ctx types6.Context, name string) (*types7.Capability, bool) {
	m.ctrl.T.Helper()
...
func (m *MockScopedKeeper) LookupModules(ctx types6.Context, name string) ([]string, *types7.Capability, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LookupModules", ctx, name)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(*types7.Capability)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
// SlashConsumerFinalityProvider mocks base method.
func (m *MockBTCStakingKeeper) SlashConsumerFinalityProvider(ctx context.Context, consumerID string, fpBTCPK *types.BIP340PubKey) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SlashConsumerFinalityProvider", ctx, consumerID, fpBTCPK)
	ret0, _ := ret[0].(error)
	return ret0
}

// SlashConsumerFinalityProvider indicates an expected call of SlashConsumerFinalityProvider.
func (mr *MockBTCStakingKeeperMockRecorder) SlashConsumerFinalityProvider(ctx, consumerID, fpBTCPK interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SlashConsumerFinalityProvider", reflect.TypeOf((*MockBTCStakingKeeper)(nil).SlashConsumerFinalityProvider), ctx, consumerID, fpBTCPK)
}
...
func (m *MockBTCStkConsumerKeeper) GetConsumerFinalityProvider(ctx context.Context, consumerID string, fpBTCPK *types.BIP340PubKey) (*types2.FinalityProvider, error) {
	m.ctrl.T.Helper()
...
func (m *MockBTCStkConsumerKeeper) SetConsumerFinalityProvider(ctx context.Context, fp *types2.FinalityProvider) {
	m.ctrl.T.Helper()
