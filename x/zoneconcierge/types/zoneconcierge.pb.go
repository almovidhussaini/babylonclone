...
// source: ybtc/zoneconcierge/v1/zoneconcierge.proto
...
import (
	...
	types3 "github.com/amovidhussaini/ybtcclone/x/btclightclient/types"
...
type IndexedHeader struct {
	...
	// header
	ybtcHeaderHash []byte `protobuf:"bytes,5,opt,name=ybtc_header_hash,json=ybtcHeaderHash,proto3" json:"ybtc_header_hash,omitempty"`
	// ybtc_header_height is the height of the ybtc block that includes this CZ
	// header
	ybtcHeaderHeight uint64 `protobuf:"varint,6,opt,name=ybtc_header_height,json=ybtcHeaderHeight,proto3" json:"ybtc_header_height,omitempty"`
	// epoch is the epoch number of this header on ybtc ledger
	ybtcEpoch uint64 `protobuf:"varint,7,opt,name=ybtc_epoch,json=ybtcEpoch,proto3" json:"ybtc_epoch,omitempty"`
	...
	ybtcTxHash []byte `protobuf:"bytes,8,opt,name=ybtc_tx_hash,json=ybtcTxHash,proto3" json:"ybtc_tx_hash,omitempty"`
}
...
func (m *IndexedHeader) GetybtcHeaderHash() []byte {
	if m != nil {
		return m.ybtcHeaderHash
	}
	return nil
}

func (m *IndexedHeader) GetybtcHeaderHeight() uint64 {
	if m != nil {
		return m.ybtcHeaderHeight
	}
	return 0
}

func (m *IndexedHeader) GetybtcEpoch() uint64 {
	if m != nil {
		return m.ybtcEpoch
	}
	return 0
...
func (m *IndexedHeader) GetybtcTxHash() []byte {
	if m != nil {
		return m.ybtcTxHash
	}
	return nil
...
// certificate. Such forks exist since ybtc considers CZs might have
...
type ChainInfoWithProof struct {
	...
	// is committed  to `app_hash` of the sealer header of latest_header.ybtc_epoch
...
func init() {
	proto.RegisterType((*IndexedHeader)(nil), "ybtc.zoneconcierge.v1.IndexedHeader")
	proto.RegisterType((*Forks)(nil), "ybtc.zoneconcierge.v1.Forks")
	proto.RegisterType((*ChainInfo)(nil), "ybtc.zoneconcierge.v1.ChainInfo")
	proto.RegisterType((*ChainInfoWithProof)(nil), "ybtc.zoneconcierge.v1.ChainInfoWithProof")
	proto.RegisterType((*FinalizedChainInfo)(nil), "ybtc.zoneconcierge.v1.FinalizedChainInfo")
	proto.RegisterType((*ProofEpochSealed)(nil), "ybtc.zoneconcierge.v1.ProofEpochSealed")
	proto.RegisterType((*ProofFinalizedChainInfo)(nil), "ybtc.zoneconcierge.v1.ProofFinalizedChainInfo")
	proto.RegisterType((*BTCChainSegment)(nil), "ybtc.zoneconcierge.v1.BTCChainSegment")
}

func init() {
	proto.RegisterFile("ybtc/zoneconcierge/v1/zoneconcierge.proto", fileDescriptor_ab886e1868e5c5cd)
}
...
func (m *IndexedHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ybtcTxHash) > 0 {
		i -= len(m.ybtcTxHash)
		copy(dAtA[i:], m.ybtcTxHash)
		i = encodeVarintZoneconcierge(dAtA, i, uint64(len(m.ybtcTxHash)))
		i--
		dAtA[i] = 0x42
	}
	if m.ybtcEpoch != 0 {
		i = encodeVarintZoneconcierge(dAtA, i, uint64(m.ybtcEpoch))
		i--
		dAtA[i] = 0x38
	}
	if m.ybtcHeaderHeight != 0 {
		i = encodeVarintZoneconcierge(dAtA, i, uint64(m.ybtcHeaderHeight))
		i--
		dAtA[i] = 0x30
	}
	if len(m.ybtcHeaderHash) > 0 {
		i -= len(m.ybtcHeaderHash)
		copy(dAtA[i:], m.ybtcHeaderHash)
		i = encodeVarintZoneconcierge(dAtA, i, uint64(len(m.ybtcHeaderHash)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Time != nil {
...
func (m *IndexedHeader) Size() (n int) {
	...
	l = len(m.ybtcHeaderHash)
	if l > 0 {
		n += 1 + l + sovZoneconcierge(uint64(l))
	}
	if m.ybtcHeaderHeight != 0 {
		n += 1 + sovZoneconcierge(uint64(m.ybtcHeaderHeight))
	}
	if m.ybtcEpoch != 0 {
		n += 1 + sovZoneconcierge(uint64(m.ybtcEpoch))
	}
	l = len(m.ybtcTxHash)
	if l > 0 {
		n += 1 + l + sovZoneconcierge(uint64(l))
...
func (m *IndexedHeader) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ybtcHeaderHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ybtcHeaderHash = append(m.ybtcHeaderHash[:0], dAtA[iNdEx:postIndex]...)
			if m.ybtcHeaderHash == nil {
				m.ybtcHeaderHash = []byte{}
			}
			iNdEx = postIndex
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ybtcHeaderHeight", wireType)
			}
			m.ybtcHeaderHeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowZoneconcierge
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ybtcHeaderHeight |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ybtcEpoch", wireType)
			}
			m.ybtcEpoch = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ybtcEpoch |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ybtcTxHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ybtcTxHash = append(m.ybtcTxHash[:0], dAtA[iNdEx:postIndex]...)
			if m.ybtcTxHash == nil {
				m.ybtcTxHash = []byte{}
			}
			iNdEx = postIndex
