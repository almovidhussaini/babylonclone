...
// source: ybtc/epoching/v1/epoching.proto
...
type ValStateUpdate struct {
	State       BondState  `protobuf:"varint,1,opt,name=state,proto3,enum=ybtc.epoching.v1.BondState" json:"state,omitempty"`
...
func init() {
	proto.RegisterEnum("ybtc.epoching.v1.BondState", BondState_name, BondState_value)
	proto.RegisterType((*Epoch)(nil), "ybtc.epoching.v1.Epoch")
	proto.RegisterType((*QueuedMessage)(nil), "ybtc.epoching.v1.QueuedMessage")
	proto.RegisterType((*ValStateUpdate)(nil), "ybtc.epoching.v1.ValStateUpdate")
	proto.RegisterType((*ValidatorLifecycle)(nil), "ybtc.epoching.v1.ValidatorLifecycle")
	proto.RegisterType((*DelegationStateUpdate)(nil), "ybtc.epoching.v1.DelegationStateUpdate")
	proto.RegisterType((*DelegationLifecycle)(nil), "ybtc.epoching.v1.DelegationLifecycle")
	proto.RegisterType((*Validator)(nil), "ybtc.epoching.v1.Validator")
}

func init() {
	proto.RegisterFile("ybtc/epoching/v1/epoching.proto", fileDescriptor_2f2f209d5311f84c)
}
