...
type MsgInsertHeaders struct {
	...
	Headers []github_com_babylonlabs_io_babylon_types.BTCHeaderBytes `protobuf:"bytes,2,rep,name=headers,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BTCHeaderBytes" json:"headers,omitempty"`
}
