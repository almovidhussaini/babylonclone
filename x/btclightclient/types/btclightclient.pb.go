...
type BTCHeaderInfo struct {
	Header *github_com_babylonlabs_io_babylon_types.BTCHeaderBytes     `protobuf:"bytes,1,opt,name=header,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BTCHeaderBytes" json:"header,omitempty"`
	Hash   *github_com_babylonlabs_io_babylon_types.BTCHeaderHashBytes `protobuf:"bytes,2,opt,name=hash,proto3,customtype=github.com/almovidhussaini/babylonclone/types.BTCHeaderHashBytes" json:"hash,omitempty"`
